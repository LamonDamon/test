...
public class HammeyEntity extends Monster {
	public HammeyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ModOfTheTrioModEntities.HAMMEY.get(), world);
	}

	public HammeyEntity(EntityType<HammeyEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
